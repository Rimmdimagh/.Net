...
{ FirstName = "steave", 
    LastName = "jobs", 
    EmailAddress = "steeve.jobs@gmail.com", 
...
//initialiseur d'objet 
Staff s1 = new Staff { FirstName = "Bill", 
    LastName = "Gates", 
    EmailAddress = "Bill.gates@gmail.com", 
    BirthDate = new DateTime(1945, 01, 01), 
    EmployementDate = new DateTime(1990, 01, 01), Salary = 99999 };
//initialiseur d'objet 
Traveller t1 = new Traveller { 
    FirstName = "Mark", 
    LastName = "Zuckerburg", 
    EmailAddress = "Mark.Zuckerburg@gmail.com", 
